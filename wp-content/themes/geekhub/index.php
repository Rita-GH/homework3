    ...
    <div id="content">
        <div class="home">
            ...
            <ul class="types">
                ...
                <li>
                    <img src="<?php bloginfo('template_url')?>/images/icon-adv-cms.png" />
                ...
                <li>
                    <img src="<?php bloginfo('template_url')?>/images/icon-adv-php.png" />
                ...
                <li class="left-col">
                    <img src="<?php bloginfo('template_url')?>/images/icon-js.png" />
                ...
                <li>
                    <img src="<?php bloginfo('template_url')?>/images/icon-ios.png" />
                ...
                <li class="left-col">
                    <img src="<?php bloginfo('template_url')?>/images/icon-ruby.png" />
                ...
                <li>
                    <img src="<?php bloginfo('template_url')?>/images/icon-grails.png" />
                ...
                <li class="left-col">
                    <img src="<?php bloginfo('template_url')?>/images/icon-pm.png" />
                ...
                <li>
                    <img src="<?php bloginfo('template_url')?>/images/icon-qa.png" />
                ...
                <li>
                    <img src="<?php bloginfo('template_url')?>/images/icon-english.png" />
                ...
                <li>
                    <img src="<?php bloginfo('template_url')?>/images/icon-webdesign.png" />
                ...
                <li>
                    <img src="<?php bloginfo('template_url')?>/images/icon-gamedesign.png" />
